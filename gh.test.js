...
describe("Github page tests1", () => { // мои тесты
	...
	test('test1', async () => {
		heading = "body > div.logged-in.env-production.page-responsive > div.application-main > main > div:nth-child(2) > div > div > div.col-md-8.col-lg-6.py-4 > article:nth-child(2) > div.border-top.color-bg-default.p-3.rounded-bottom-2 > div.d-flex > h3 > a"
		await page.waitForSelector(heading, {
			timeout: 60000
		});
		await page.click(heading);
		await expect(page).toHaveURL('https://www.youtube.com/playlist?list=PL0lo9MOBetEE0goMLEl97vO7slruNVj43', {
			timeout: 60000
		});
	});
